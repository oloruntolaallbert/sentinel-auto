...
// Create role assignment for deployment script
resource roleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(resourceGroup().id, 'sentinel-contributor', customerName)
  properties: {
    ...
    principalId: deployAllOOTBRules.identity.principalId
  }
}
