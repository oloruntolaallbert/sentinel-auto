// main.bicep - Complete MSSP Sentinel Deployment
...
// This uses a deployment script to automatically enable all OOTB rules
...
resource deployOOTBRules 'Microsoft.Resources/deploymentScripts@2020-10-01' = if (enableAllOOTBRules) {
  ...
  properties: {
    ...
    scriptContent: '''
      ...
      $templatesUri = "https://management.azure.com/subscriptions/$subscriptionId/resourceGroups/$resourceGroupName/providers/Microsoft.OperationalInsights/workspaces/$workspaceName/providers/Microsoft.SecurityInsights/alertRuleTemplates?api-version=2021-10-01"
          ...
          foreach ($template in $templates) {
              ...
              if ($template.kind -eq "Scheduled" -or $template.kind -eq "NRT") {
                  ...
                  if ($shouldDeploy) {
                      ...
                      $createRuleUri = "https://management.azure.com/subscriptions/$subscriptionId/resourceGroups/$resourceGroupName/providers/Microsoft.OperationalInsights/workspaces/$workspaceName/providers/Microsoft.SecurityInsights/alertRules/$ruleName" + "?api-version=2021-10-01"
